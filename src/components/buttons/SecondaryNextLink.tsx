...
const baseStyle =
  'inline-flex items-center justify-center rounded-[2px] font-bold leading-none text-gray-90 focus:border-white focus:bg-gray-30 focus:outline-1 focus:outline-offset-2 focus:outline-blue-60';
